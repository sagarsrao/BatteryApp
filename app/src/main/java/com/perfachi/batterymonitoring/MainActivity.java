package com.perfachi.batterymonitoring;
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(status == BatteryManager.BATTERY_STATUS_CHARGING)
            {
                ...
                image.setImageResource(R.drawable.outline_battery_charging_full_black_36);
            ...
            if(status == BatteryManager.BATTERY_STATUS_DISCHARGING)
            {
                ...
                image.setImageResource(R.drawable.outline_battery_alert_black_36);
            }

            if (status == BatteryManager.BATTERY_STATUS_FULL)
            {
                charging_status = "Battery Full";
                image.setImageResource(R.drawable.outline_battery_full_black_36);
            ...
            if(status == BatteryManager.BATTERY_STATUS_UNKNOWN)
            {
                ...
                image.setImageResource(R.drawable.outline_battery_unknown_black_36);
            }

            if (status == BatteryManager.BATTERY_STATUS_NOT_CHARGING)
            {
                charging_status = "Not Charging";
                image.setImageResource(R.drawable.icon_no_charging);
            }
